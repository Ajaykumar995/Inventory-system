  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {orders.map((po) => (
          <div key={po.id} className="glass rounded-2xl border border-white/10 p-5">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
              ...
              <div className="flex items-center gap-3">
                ...
                {(po.status === 'ordered' || po.status === 'partial') && (
                  <button onClick={() => receiveAll(po)} className="px-4 py-1.5 rounded-xl bg-cyan-600 hover:bg-cyan-500 text-white text-xs transition">
                    Receive Stock
                  </button>
                )}
              </div>
