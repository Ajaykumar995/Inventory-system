...
import type { Supplier, SupplierPerformance } from '../types/purchase'
...
export default function SuppliersPage() {
  ...
  const showPerf = async (id: number) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {items.map((s) => (
          <div key={s.id} className="glass rounded-2xl border border-white/10 p-5 hover:border-violet-500/30 transition">
