  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {cards.map((c) => (
          <div key={c.key} className="glass rounded-2xl border border-white/10 p-5 space-y-3">
            ...
            <button
              onClick={c.action}
              disabled={exporting === c.key}
              className="w-full py-2 rounded-xl bg-emerald-600/80 hover:bg-emerald-500 text-white text-sm disabled:opacity-50 transition"
            >
