...
export default function StatCard({ label, value, icon, glow = 'blue', trend }: StatCardProps) {
  return (
    <div className={`glass rounded-2xl p-5 border ${glowMap[glow]} transition-transform hover:scale-[1.02]`}>
